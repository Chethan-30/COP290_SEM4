...
void Game::initialize(const char* title,int xpos,int ypos,int width,int height,bool fullscreen){
               //  const char*hello1=temp899.c_str();
                //printf("%s",hello1);
  //printf("fghghgdhhgffghdghgdhfghfghfghfg");
...
diamond1 =new Gameobject("pictures/diamond.png",1376,0);
diamond2 =new Gameobject("pictures/diamond.png",160,640);
diamond3 =new Gameobject("pictures/diamond.png",160,992);
diamond4 =new Gameobject("pictures/diamond.png",32,384);
diamond5 =new Gameobject("pictures/diamond.png",384,384);
diamond6 =new Gameobject("pictures/diamond.png",1056,736);
diamond7 =new Gameobject("pictures/diamond.png",1536,608);
diamond8 =new Gameobject("pictures/diamond.png",1504,352);
diamond9 =new Gameobject("pictures/diamond.png",320,768);
diamond10 =new Gameobject("pictures/diamond.png",1152,128);
...
stringstream stream_other;   
 ...
 stream_other<<hp3;
  ...
  const char *temp15=temp_other.c_str();
...
stringstream ss12;  
  ...
  ss12>>s12;  
  temp52=temp52+s12;
  const char *temp32=temp52.c_str();
...
// assignments
  if(Task1){
   ...
   if(Task2){
   if (toggle==1 && key1_to_exist ){key1->render(); printf("%s\n","okokok");}
...
if(death_count==20){a->startmenuTogamemusic();}
...
if(song_count==20){a->startmenuTogamemusic();}
 //diamonds
...
vector<int>return1;
  ...
  return1=sendHPdataClient(hp_score);
  hp3=return1[0];
  playscore2=return1[1];
...
stringstream stream_other;   
 ...
 stream_other<<hp3;
   ...
   temp_other=temp_other+s111;
  const char *temp15=temp_other.c_str();
text5=score->loadFromRenderedText(temp15,textColor);
